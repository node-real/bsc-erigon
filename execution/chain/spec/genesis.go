...
var (
	...
	bscChainConfig     = ReadChainConfig(chainspecs, "chainspecs/bsc.json")
	chapelChainConfig  = ReadChainConfig(chainspecs, "chainspecs/chapel.json")
	rialtoChainConfig  = ReadChainConfig(chainspecs, "chainspecs/rialto.json")
)
