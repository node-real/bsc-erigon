...
func NewBlockReader(snapshots snapshotsync.BlockSnapshots, borSnapshots snapshotsync.BlockSnapshots, bscSnapshot snapshotsync.BlockSnapshots) *BlockReader {
	borSn, _ := borSnapshots.(*heimdall.RoSnapshots)
	sn, _ := snapshots.(*RoSnapshots)
	bscSn, _ := bscSnapshot.(*BscRoSnapshots)
	br := &BlockReader{sn: sn, borSn: borSn, bscSn: bscSn}
