...
func InitSchemas() {
	...
	Schema.AccountsDomain.hist.iiCfg.version.DataEF = version.V1_0_standart
	Schema.AccountsDomain.hist.iiCfg.version.AccessorEFI = version.V1_0_standart
	...
	Schema.StorageDomain.hist.iiCfg.version.DataEF = version.V1_0_standart
	Schema.StorageDomain.hist.iiCfg.version.AccessorEFI = version.V1_0_standart
	...
	Schema.CodeDomain.hist.iiCfg.version.DataEF = version.V1_0_standart
	Schema.CodeDomain.hist.iiCfg.version.AccessorEFI = version.V1_0_standart
	...
	Schema.CommitmentDomain.hist.iiCfg.version.DataEF = version.V1_0_standart
	Schema.CommitmentDomain.hist.iiCfg.version.AccessorEFI = version.V1_0_standart
	...
	Schema.ReceiptDomain.hist.iiCfg.version.DataEF = version.V1_0_standart
	Schema.ReceiptDomain.hist.iiCfg.version.AccessorEFI = version.V1_0_standart
	...
	Schema.RCacheDomain.hist.iiCfg.version.DataEF = version.V1_0_standart
	Schema.RCacheDomain.hist.iiCfg.version.AccessorEFI = version.V1_0_standart

	Schema.LogAddrIdx.version.DataEF = version.V1_0_standart
	Schema.LogAddrIdx.version.AccessorEFI = version.V1_0_standart

	Schema.LogTopicIdx.version.DataEF = version.V1_0_standart
	Schema.LogTopicIdx.version.AccessorEFI = version.V1_0_standart

	Schema.TracesFromIdx.version.DataEF = version.V1_0_standart
	Schema.TracesFromIdx.version.AccessorEFI = version.V1_0_standart

	Schema.TracesToIdx.version.DataEF = version.V1_0_standart
	Schema.TracesToIdx.version.AccessorEFI = version.V1_0_standart
