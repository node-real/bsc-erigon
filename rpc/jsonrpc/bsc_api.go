...
import (
	...
	parlia2 "github.com/erigontech/erigon/execution/consensus/parlia"
...
type BscAPI interface {
	...
	GetDiffAccounts(ctx context.Context, blockNr rpc.BlockNumber) ([]common.Address, error)
	GetDiffAccountsWithScope(ctx context.Context, blockNr rpc.BlockNumber, accounts []common.Address) (*types.DiffAccountsInBlock, error)
	...
	GetTransactionDataAndReceipt(ctx context.Context, hash common.Hash) (map[string]interface{}, error)
	GetTransactionReceiptsByBlockNumber(ctx context.Context, number rpc.BlockNumberOrHash) ([]map[string]interface{}, error)
	Health(ctx context.Context) bool
	Resend(ctx context.Context, sendArgs map[string]interface{}, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error)
	GetTransactionsByBlockNumber(ctx context.Context, blockNr rpc.BlockNumber) ([]*ethapi.RPCTransaction, error)
	GetVerifyResult(ctx context.Context, blockNr rpc.BlockNumber, blockHash common.Hash, diffHash common.Hash) ([]map[string]interface{}, error)
	...
	GetBlobSidecarByTxHash(ctx context.Context, hash common.Hash, fullBlob *bool) (map[string]interface{}, error)
...
func (api *BscImpl) parlia() (*parlia2.Parlia, error) {
	type lazy interface {
		HasEngine() bool
	...
	case lazy:
		if engine.HasEngine() {
			if parlia, ok := engine.Engine().(*parlia2.Parlia); ok {
				return parlia, nil
			}
		}
	}
...
func (api *BscImpl) Etherbase(ctx context.Context) (common.Address, error) {
...
func (api *BscImpl) GetDiffAccountsWithScope(ctx context.Context, blockNr rpc.BlockNumber, accounts []common.Address) (*types.DiffAccountsInBlock, error) {
...
func (api *BscImpl) GetDiffAccounts(ctx context.Context, blockNr rpc.BlockNumber) ([]common.Address, error) {
...
func (api *BscImpl) GetHeaderByHash(ctx context.Context, hash common.Hash) (map[string]interface{}, error) {
...
func (api *BscImpl) GetTransactionDataAndReceipt(ctx context.Context, hash common.Hash) (map[string]interface{}, error) {
...
func (api *BscImpl) Resend(ctx context.Context, sendArgs map[string]interface{}, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	return common.Hash{}, fmt.Errorf(NotImplemented, "eth_resend")
}
...
func (api *BscImpl) GetVerifyResult(ctx context.Context, blockNr rpc.BlockNumber, blockHash common.Hash, diffHash common.Hash) ([]map[string]interface{}, error) {
...
func (api *BscImpl) GetBlobSidecarByTxHash(ctx context.Context, hash common.Hash, fullBlob *bool) (map[string]interface{}, error) {
	showBlob := true
	if fullBlob != nil {
		showBlob = *fullBlob
	}
...
func (api *BscImpl) getFinalizedNumber(ctx context.Context, verifiedValidatorNum int64) (int64, error) {
	...
	curValidators, err := service.(*parlia2.API).GetValidators(&currentHead)
	if err != nil { // impossible
		return 0, err
	}
