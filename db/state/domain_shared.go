...
func (sd *SharedDomains) ResetCommitment() {
	sd.sdCtx.ResetCommitment()
}

func (sd *SharedDomains) SaveCommitment(blockNum, txNum uint64, rootHash []byte) error {
	return sd.sdCtx.SaveCommitment(blockNum, txNum, rootHash)
}
