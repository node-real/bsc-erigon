...
func (back *RemoteBackend) BlobStore() services.BlobStorage       { panic("not implemented") }
...
func (back *RemoteBackend) FrozenBscBlocks() uint64               { return back.blockReader.FrozenBscBlocks() }
